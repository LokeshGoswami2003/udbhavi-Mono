...
export function DashboardView({ view, resumes, projects, onCreateProject, onDeleteProject, onPrimaryResume, onDeleteResume, onEditResume }) {
            ...
            {resumes.map((resume) => (
              <article key={resume.id} className="rounded-lg border border-slate-200 p-4 dark:border-white/10">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {onEditResume ? (
                    <Button as="button" type="button" variant="accent" className="min-h-9 px-3 py-2 text-xs" onClick={() => onEditResume(resume.id)}>
